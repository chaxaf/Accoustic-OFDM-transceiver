function [rxbits conf channel] = ofdm_rx(rxsignal, conf)
...
Ng = ceil(conf.n_g*conf.f_s/conf.f_spacing);
Ns = N+Ng;
...
pilot_decoded = 0;
for i = 2:conf.redondancy*conf.n_ofdm_symbols+1
